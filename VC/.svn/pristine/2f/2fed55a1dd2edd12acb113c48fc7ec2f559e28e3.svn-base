...
<div id="docIssuedAddPage" style="width: 100%">
	<form id="addForm" name="addForm" action="#" method="post"
		...
		<table id="mainTable" style="width: 100%">
					...
					<table cellpadding="0" cellspacing="0" border="0" width="100%">
						<tr>
							<td class="f-black" height="20" valign="top">
								...
								&nbsp;
								<!-- 使用人单证发放录入  -->
								<s:text name="store.docProvideInput" />
							</td>
						</tr>
						<tr>
			...
			<tr id="tre">
				<td>
					<div style="width: 98%">
						<span id="docIssuedInput" style="width: 100%"></span>
					</div>
				</td>
			</tr>
			...
			<tr>
				<td style="padding-left: 30px;" colspan="4" align="center">
					<input type="button" id="saveBut" class="taButton"
						value="<s:text name="common.submit.send" />" />
					&nbsp;&nbsp;&nbsp;&nbsp;
