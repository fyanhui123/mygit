...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head><meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8">
		<script type="text/javascript" src="${ctx}/pages/newInvoice/js/LostApplyEdit.js"></script>
...
<div id="lostApplyEditPage" style="width: 100%">
	<form id="lostEditForm" name="editForm" action="${ctx }/newinvoice/saveInvoiceLostApply.do" method="post"
