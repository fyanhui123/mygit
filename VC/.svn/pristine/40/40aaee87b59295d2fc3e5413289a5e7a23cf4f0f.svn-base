...
<div id="readOnlyPageCancelUsage" class="tab-center">
	<table style="width: 100%">
		<tr>
			<td id="mainTableLeftTd">
				<table width="100%" id="mainTable" style="width: 100%">
					<tr onclick="common.hideTR('trbCancelUsageReadonly','hideImg1')">
						<td>
							...
							<table class="inputTable3col" style="width: 100%">
										...
										<table style="width: 100%">
											...
											<tr>
												...
												<td class="inputBox3col_text" nowrap="nowrap" colspan="3">
													<textarea id="readOnly_cancelReason" name="cancelReason" disabled="disabled" style="width: 60%" class="">${cancel.cancelReason }</textarea>
												</td>
											</tr>
										</table>
									</td>
								...
								<tr>
									<td class="inputTitle3col_btn" colspan="4"  align="center">
										<input type="button" id="cancelButCancelUsageReadoly" value='<s:text name="usage.common.back" />' />&nbsp;&nbsp;&nbsp;&nbsp;
									</td>
								</tr>
							</table>
						</td>
