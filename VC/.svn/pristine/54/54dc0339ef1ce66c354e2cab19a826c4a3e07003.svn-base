										...
										<table>
											...
											<tr>
												...
												<td colspan="3" class="inputBox3col_text" nowrap="nowrap">
													<textarea id="applyReason" value="" name="applyReason" type="text" disabled="disabled" style="width: 60%" rows="4">${vcAllot.allotReason }</textarea>
												</td>
											</tr>	
										</table>
									</td>
								...
								<tr>
									<td>
										...
										<div id="SpanDivProvideConfirm">
											<textarea id="editProvideConfirm_hiddenDet" name="editProvideConfirm_hiddenDet" type="text"  style="display: none;" rows="4">${jsonStr}</textarea>
