...
<div id="viewPageAllot" class="tab-center" >
						...
						<td>
							<table style="width: 100%">
								<tr>
									...
									<td width="24%">
										<input id="view_applyCode" value="${vcAllot.allotCode }" name="applyCode" type="text"  disabled="disabled"/> 
									</td>
									<td width="12%" align="right"><s:text name="store.applyTime" /></td>
									<td width="24%">
										<input id="view_applyTime" value="<fmt:formatDate value='${vcAllot.allotTime}' type='date' pattern='yyyy-MM-dd HH:mm:ss' />" name="applyTime" type="text" disabled="disabled"  />
									</td>	
								</tr>
								<tr >
									...
									<td width="24%">
										<input id="view_applyOrgCode" value="${vcAllot.allotOrgCode }" name="applyOrgCode" type="text"  disabled="disabled"/>
									</td>
									<td width="12%" align="right" >
										<s:text name="store.applyOrgName" />
									</td>
									<td width="24%">
										<input id="view_applyOrgName" value="${vcAllot.allotOrgName }" name="applyOrgName" type="text" disabled="disabled"/>
									</td>
								</tr>
								<tr>
									<td width="12%" align="right" ><s:text name="store.applyOprCode" /></td>
									<td width="24%">
										<input id="view_applyOprCode" value="${vcAllot.allotOprCode }" name="applyOprCode" type="text"  disabled="disabled" />
									</td>
									<td width="12%" align="right" ><s:text name="store.applyOprName" /></td>
									<td width="24%">
										<input id="view_applyOprName" value="${vcAllot.allotOprName }" name="applyOprName" type="text" disabled="disabled"/>
									</td>
								</tr>											
								<tr >
									<td width="12%" align="right">
									...
									<td width="24%">
										<input id="view_provideOrgCode" value="${vcAllot.provideOrgCode }" name="provideOrgCode" type="text"  disabled="disabled"/>
									</td>
									<td width="12%" align="right" >
										<s:text name="store.provideOrgName" />
									</td>
									<td width="24%">
										<input id="view_provideOrgName" value="${vcAllot.provideOrgName }" name="provideOrgName" type="text" disabled="disabled"/>
									</td>
								</tr>
								<tr>
									<td width="12%" align="right"><s:text name="store.applyReason" /></td>
									<td colspan="3" width="24%">
										<textarea id="view_applyReason" value="" name="applyReason" type="text"  style="width: 60%" rows="4" disabled="disabled">${vcAllot.allotReason }</textarea>
