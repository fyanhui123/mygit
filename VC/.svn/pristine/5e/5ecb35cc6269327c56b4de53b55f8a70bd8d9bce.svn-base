...
<div id="PayFeeAccountPage" style="width: 100%">
		...
		<table width="100%" class="inputTable3col">
			<!--  <tr>
				...
				<td><select id="bankInfoDtoPayeeType" name="bankInfoDto.payeeType"
					class="selectStyle required" style="width: 155px">
			...
			<td width="12%" class="inputTitle3col">银行账号</td>
				<td><input id="bankInfoDtoPayeeBankAccount"
					name="bankInfoDto.payeeBankAccount" value="${bankInfoDto.payeeBankAccount}"  class="required" type="text"/></td>
				<td width="12%" class="inputTitle3col">账户名称</td>
				<td><input id="bankInfoDtoPayeeBankAccountName" name="bankInfoDto.payeeBankAccountName"  class="required"  value="${bankInfoDto.payeeBankAccountName}" type="text" /></td>
			</tr>
			<tr>
			 <td width="12%" class="inputTitle3col">银行</td>
				<td width="38%" class="inputBox3col_text">
				<input id="bankInfoDtoPayeeBankCode" name="bankInfoDto.payeeBankCode" value="${bankInfoDto.payeeBankCode}" type="text" class="ui-autocomplete-input required" /> 
				<input id="bankInfoDtoPayeeBankCodeName" name="bankInfoDto.payeeBankName" value="${bankInfoDto.payeeBankName}" type="text" class="ui-widget-content ui-autocomplete-label required" readonly="readonly" />
			 </td>
			 <td width="12%" class="inputTitle3col">收款方区域编码</td>
				<td width="38%" class="inputBox3col_text">
				<input id="bankInfoDtoPayeeAreaCode" name="bankInfoDto.payeeAreaCode"  value="${bankInfoDto.payeeAreaCode}" type="text" class="ui-autocomplete-input required" /> 
				<input id="bankInfoDtoPayeeAreaCodeName" name="bankInfoDto.payeeAreaName" value="${bankInfoDto.payeeAreaName}" type="text" class="ui-widget-content ui-autocomplete-label required" readonly="readonly" />
			</td>
			</tr>
			 <tr>
			   <td width="12%" class="inputTitle3col">开户支行（联行号）</td>
			   <td>
			    <input id="bankInfoDtoPayeeBankLocationCode"  name="bankInfoDto.payeeBankLocationCode" value="${bankInfoDto.payeeBankLocationCode}"  type="text" class="ui-autocomplete-input required" /> 
				 <input id="bankInfoDtoPayeeBankLocationCodeName"  name="bankInfoDto.payeeBankLocationName"  value="${bankInfoDto.payeeBankLocationName}" type="text" class="ui-widget-content ui-autocomplete-label required" readonly="readonly" />
			   </td>
			   <!-- <td width="12%" class="inputTitle3col">收款方联行号编码</td>
				<td width="38%" class="inputBox3col_text">
				<input id="bankInfoDtoCnapsCode" name="bankInfoDto.cnapsCode" value="999999999999" type="text" class="ui-autocomplete-input required" /> 
			...
			<tr>
			 <td width="12%" class="inputTitle3col">加急标志 </td>
			   <td>
				  ...
				  <select id="bankInfoDtoFastFlag" name="bankInfoDto.fastFlag" class="selectStyle required" style="width: 155px">
			   ...
			   <td>
				  ...
				  <select id="bankInfoDtoCorpInd" name="bankInfoDto.corpInd" class="selectStyle required" style="width: 155px">
			 ...
			 <td width="38%" class="inputBox3col_text">
			     <input type="hidden"  id="bankInfoDtoSmsFlag_hidden" value="${bankInfoDto.smsFlag}">
				  <select id="bankInfoDtoSmsFlag" name="bankInfoDto.smsFlag" class="selectStyle required" style="width: 155px">
					<option value="0">否</option>
					<option value="1">是</option>
				  </select>
			  </td>
			  ...
			  <td width="38%" class="inputBox3col_text">
			   <input id="bankInfoDtoCellPhone" name="bankInfoDto.cellPhone" value="${bankInfoDto.cellPhone}" type="text"/> 
			  </td>
			</tr>
			<tr>		
			 ...
			 <td width="38%" class="inputBox3col_text">
			     <input type="hidden"  id="bankInfoDtoMailFlag_hidden" value="${bankInfoDto.mailFlag}">
				  <select id="bankInfoDtoMailFlag" name="bankInfoDto.mailFlag" class="selectStyle required" style="width: 155px">
					<option value="0">否</option>
					<option value="1">是</option>
				  </select>
			  </td>
			  ...
			  <td width="38%" class="inputBox3col_text">
			   <input id="bankInfoDtoMailAddr" name="bankInfoDto.mailAddr" value="${bankInfoDto.mailAddr}" type="text"/> 
			  </td>
			</tr>
			<!-- <tr>
			 <td width="12%" class="inputTitle3col">短信通知</td>
			...
			<tr>	
              <td width="12%" class="inputTitle3col">证件类型 </td>
			   ...
			   <td><input id="bankInfoDtoCertNumber"  name="bankInfoDto.certNumber" value="${bankInfoDto.certNumber}" type="text" /></td>
			 </tr>
             <tr>
				...
				<td width="38%" class="inputBox3col_text" colspan="3">
				  <textarea  name="bankInfoDto.purpose"  rows="3" style="width: 50%"  class="required"  maxlength="500">${bankInfoDto.purpose}</textarea> 									
				</td>
			</tr>
			<tr>
				<td width="12%" class="inputTitle3col">
				...
				<td width="38%" class="inputBox3col_text" colspan="3">
				  <textarea  name="bankInfoDto.memo"  rows="3" style="width: 50%"  class="required"  maxlength="500">${bankInfoDto.memo}</textarea> 									
				</td>
			</tr>
			<tr>
				<td colspan="4">&nbsp;</td>
