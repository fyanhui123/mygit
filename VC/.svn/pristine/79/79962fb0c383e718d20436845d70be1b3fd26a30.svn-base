...
<script type="text/javascript" src="${ctx}/pages/role/js/RoleTakeListQuiry.js"></script>
<script type="text/javascript">
	$(document).ready(function () {
	    common.initHtml("roleTakerListInquiry");
	    roleTakerListInquiry.initPage();
	});
</script>
</head>
<body>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								<td  height="28" valign="center">
									<img src="${ctx}/style/default/images/point4.gif" class="bottom">单证使用人清单查询条件
