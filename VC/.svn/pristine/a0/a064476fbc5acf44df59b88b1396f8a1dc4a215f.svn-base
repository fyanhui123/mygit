...
<!--引入jsp配对的js文件 -->
<script type="text/javascript" src="${ctx}/pages/insucard/js/InsuCardRefundEdit.js"></script>
<script type="text/javascript" src="${ctx}/pages/store/js/ValidStorage.js"></script>
<script type="text/javascript">
 $(document).ready(function () {
	insuCardRefundEdit.initPage();
 }); 
</script>
</head>
<body>
<div id="insuCardRefundEditPage" style="width: 100%">
	<form id="insuCardRefundEditForm" name="insuCardRefundEditForm" action="#" method="post" enctype="multipart/form-data">
					...
					<table width="100%" class="inputTable3col">
						...
						<tr>
							...
							<td width="38%" class="inputBox3col_text">
								...
								<input type="hidden" id="insuCardSaleRecordVoSellerName" name="insuCardSaleRecordVo.sellerName"  value="${insuCardSaleRecordVo.sellerName}" />
							</td>
							<td width="12%" class="inputTitle3col">
								退卡人机构 
							</td>
							<td>
								...
								<input type="hidden" id="insuCardSaleRecordVoSaleOrgName" name="insuCardSaleRecordVo.saleOrgName"  value="${insuCardSaleRecordVo.saleOrgName}" />
						...
						<tr>
							<td width="12%" class="inputTitle3col">退卡人类型</td>
								<td>
								  <input type="hidden"  id="bankInfoDtoPayeeType_hidden" name="bankInfoDto.payeeType"  value="${bankInfoDto.payeeType}">
								  <select id="bankInfoDtoPayeeType"  class="selectStyle" style="width: 155px"  disabled>
