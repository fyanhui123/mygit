...
public class DocDoAnnuledOldRequestDTO {
	...
	/** 流水号区间段 */
	private List<DocSerialNoScope> docSerialNoScope;
	...
	public List<DocSerialNoScope> getDocSerialNoScope() {
		return docSerialNoScope;
	}
	public void setDocSerialNoScope(List<DocSerialNoScope> docSerialNoScope) {
		this.docSerialNoScope = docSerialNoScope;
	}
