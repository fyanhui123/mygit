 ...
 */
@Entity
@Table(name = "VC_TAKER_HIS")
public class VcTakerHis implements java.io.Serializable {
	...
	//@SequenceGenerator(name = "SEQ_VC_TAKER_HIS", sequenceName = "SEQ_VC_TAKER_HIS", allocationSize = 1)
	@Id	
	//@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_VC_TAKER_HIS")
