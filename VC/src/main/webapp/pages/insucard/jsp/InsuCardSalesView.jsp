<%
	 ...
	 * 激活卡销售登记查看页面
	 ***************************************
	 * 程序名：InsuCardSalesView.jsp
	 * 建立日期：2013-07-22
	 * 作者：whj
	 * 模块：激活卡管理-激活卡销售登记查看页面
	 * 备注：
	 * -----------------------------------------
	 * 修改历史
	 * 序号 日期 修改人 修改原因
...
<div id="insuCardSalesViewPage" style="width: 100%">
	<form id="InsuCardSalesViewForm" name="InsuCardSalesViewForm" action="#" method="post" enctype="multipart/form-data">
