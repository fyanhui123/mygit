...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head><meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8">
		<script type="text/javascript" src="${ctx}/pages/newInvoice/js/DestroyEdit.js"></script>
		<script type="text/javascript" src="${ctx}/pages/newInvoice/js/ValidStorage.js"></script>
	...
	<body>
		...
		<div id="destroyEditPage" style="width: 100%">
			<form id="destroyEditForm" action="${ctx}/destroy/saveDestroy.do"
		...
		<%@ include file="/pages/newInvoice/jsp/ValidStorageQuery.jsp"%>
	</body>
</html>
