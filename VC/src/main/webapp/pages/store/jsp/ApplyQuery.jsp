		...
		<tr>
			<td id="mainTableLeftTd">
				<table width="100%" id="mainTable" style="width: 100%">
					...
					<tr id="trbApply">
						<td>
							<form action="#" id="applyQueryForm" name="applyQueryForm">
							<table class="inputTable3col" style="width: 100%">
								...
								<tr>
									<td class="inputTitle3col_btn" colspan="4" align="right">
										<input id="queryApply" type="button" class="taButton" value="<s:text name="common.submit.query" />" />&nbsp;&nbsp;&nbsp;&nbsp;
			   							<input id="resetApply" type="reset" class="taButton" value="<s:text name="common.submit.rest" /> "  onclick="common.clearGridData('applyGrid');"/>&nbsp;&nbsp;&nbsp;&nbsp;
										<input id="newApply" type="button" class="taButton" value="<s:text name="common.submit.add" />" />&nbsp;&nbsp;&nbsp;&nbsp;
			   							<input id="updateApply" type="button" class="taButton" value="<s:text name="common.submit.alter" /> " />&nbsp;&nbsp;&nbsp;&nbsp;
			   							<input id="submitApply" type="button" class="taButton" value='<s:text name="store.common.submit" />' />&nbsp;&nbsp;&nbsp;&nbsp;
			   							<input id="deleteApply" type="button" class="taButton" value="<s:text name="common.submit.delete" /> " />&nbsp;&nbsp;&nbsp;&nbsp;
			   							<input id="viewApply" type="hidden" class="taButton" value='<s:text name="store.common.view" />' />				
										<input id="exporeExcel" type="button" class="taButton" value='导出Excel' />
									</td>
								</tr>
							</table>
							</form>
					...
					<tr id="trcApply">
						<td>
							<table class="pagerTable" style="width: 100%">
								<tr>
									<td width="100%">
										<table id="applyGrid" class="inputTable3col"></table>
