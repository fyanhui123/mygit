									...
									<td>
										<table style="width: 100%">
											<tr >
												...
												<td width="10%" align="left"><s:text name="store.applyTime" /></td>
												<td width="24%">
											...
											<tr>
												...
												<td colspan="3" class="inputBox3col_text" nowrap="nowrap">
													<textarea id="applyReason" value="" name="applyReason"   type="text" style="width: 60%" rows="4">${vcApply.applyReason }</textarea>
												</td>
											</tr>											
										</table>
									</td>
								...
								<tr>
									<td>
										...
										<div id="SpanDivProvide">
											<textarea id="editProvide_hiddenDet" name="editProvide_hiddenDet" type="text"  style="display: none;" rows="4">${json}</textarea>
