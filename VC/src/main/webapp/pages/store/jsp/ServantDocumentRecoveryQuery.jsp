...
<%
	 ...
	 * 使用人单证发放查询页面
	 ***************************************
	 * 程序名：ServantDocumentRecoveryQuery.jsp
	 * 建立日期：2013-4-7
	 * 作者：Leo
	 * 模块：库存管理-使用人单证回收
	 * 备注：
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head><meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8">
		...
		<script type="text/javascript"
			src="${ctx}/pages/store/js/ServantDocumentRecoveryAdd.js"></script>
		<script type="text/javascript"
			src="${ctx}/pages/store/js/ValidAvailable.js"></script>
		<script type="text/javascript">
	$(document).ready(function () {
		common.initHtml("ServantDocumentRecoveryQuery");
		servantDoc.initPage();
	});
</script>
	</head>
	<body>
								...
								<td>
									<table width="100%" class="inputTable3col">
										...
										<tr>
											...
											<td width="12%" class="inputTitle3col">
												<!--回收时间-->
												<s:text name="store.recoveryTime" />
											</td>
											<td colspan="3" class="inputBox3col_text">
												...
												<input type="text" id="provideEndDate" name="provideEndDate"
									...
									<table cellpadding="0" cellspacing="0" border="0" width="100%">
										<tr>
											<td height="28" valign="top">
												...
												&nbsp;
												<!--使用人单证回收列表-->
												<s:text name="store.docRecoveryList" />
											</td>
											<td align="right" valign="top" nowrap="nowrap">
												...
												<input type="reset" id="restBtn" class="taButton"
													value="<s:text name="common.submit.rest" /> " onclick="common.clearGridData('serDocIssuedGatherGrid');"/>
												<input type="hidden" id="actionType" name="actionType"
													value="${actionType }" />
													&nbsp;&nbsp;&nbsp;&nbsp;
												<button id="addDocIssued" buttonId="b04" class="taButton"  type="button">
													<s:text name="common.submit.recover" />
												</button>
											</td>
										</tr>
										<tr>
		...
		<jsp:include page="ServantDocumentRecoveryAdd.jsp"></jsp:include>
		<%@ include file="ValidAvailableQuery.jsp"%>
	</body>
</html>